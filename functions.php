...
function minimum_enqueue_scripts() {
	...
	wp_enqueue_script( 'js-imagemap', get_bloginfo( 'stylesheet_directory' ) . '/js/jquery.imagemapster.js',  array( 'jquery' ) );
	wp_enqueue_script( 'js-imagemap-js', get_bloginfo( 'stylesheet_directory' ) . '/js/imagemap.js',  array( 'jquery' ), '', true );
}
...
genesis_register_sidebar( array(
'id' => 'home-topleft-full',
'name' => __( 'Home Topleft', 'minimum' ),
'description' => __( 'This is the home topleft section.', 'minimum' ),
) );
genesis_register_sidebar( array(
...
//* Register map of counties widget area
genesis_register_sidebar( array(
    'id'            => 'map-of-counties',
    'name'          => __( 'Map of Counties', 'minimum' ),
    'description'   => __( 'This is a widget area for the map of counties', 'minimum' ),
) );
