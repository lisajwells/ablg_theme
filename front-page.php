...
//* Add Home Top widgetized area
add_action( 'genesis_after_header', 'minimum_home_topleft', 5 );
function minimum_home_topleft() {
 
printf( '<div %s>', genesis_attr( 'home-topleft' ) );
genesis_structural_wrap( 'home-topleft' );
 
genesis_widget_area( 'home-topleft-full', array(
'before'=> '<div class="home-topleft-full widget-area">',
'after' => '</div>',
) );
 
genesis_structural_wrap( 'home-topleft', 'close' );
echo '</div>'; //* end .home-topleft
